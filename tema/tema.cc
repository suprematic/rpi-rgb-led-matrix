...
int main(int argc, char *argv[]) {
  ...
  while (!interrupt_received && loops != 0) {
    ...
    rgb_matrix::DrawText(offscreen_canvas, font, x + 17, y + font.baseline() - 4, color, NULL, ".", letter_spacing);
    rgb_matrix::DrawText(offscreen_canvas, font, x + 18, y + font.baseline() - 4, color, NULL, ".", letter_spacing);
    rgb_matrix::DrawText(offscreen_canvas, font, x + 17, y + font.baseline() - 3, color, NULL, ".", letter_spacing);
    rgb_matrix::DrawText(offscreen_canvas, font, x + 18, y + font.baseline() - 3, color, NULL, ".", letter_spacing);

    std::string sets_t1 = "624";
    std::string sets_t2 = "462";
    std::string game_t1 = "15";
    std::string game_t2 = "40";
    rgb_matrix::DrawText(offscreen_canvas, font, x + 22, y + font.baseline() - 1 , color, NULL, "1", letter_spacing);
    rgb_matrix::DrawText(offscreen_canvas, font, x + 27, y + font.baseline() - 1 , color, NULL, "5", letter_spacing);

    rgb_matrix::DrawText(offscreen_canvas, font, x + 22, y + font.baseline() + 8, color, NULL, "4", letter_spacing);
    rgb_matrix::DrawText(offscreen_canvas, font, x + 27, y + font.baseline() + 8, color, NULL, "0", letter_spacing);

    rgb_matrix::DrawText(offscreen_canvas, font, x     , y + font.baseline() + 8, color, NULL, sets_t2.c_str(), letter_spacing);

    // length = holds how many pixels our text takes up
    length = rgb_matrix::DrawText(offscreen_canvas, font, x, y + font.baseline() - 1, color, NULL, line.c_str(), letter_spacing);
